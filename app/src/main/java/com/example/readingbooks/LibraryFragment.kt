...
class LibraryFragment : AppCompatActivity() {
    ...
    private fun getBooksData(searchQuery: String) {
        ...
        mRequestQueue = Volley.newRequestQueue(this@LibraryFragment)
        ...
        val queue = Volley.newRequestQueue(this@LibraryFragment)
        ...
        val request = JsonObjectRequest(Request.Method.GET, url, null, { response ->
            ...
            try {
                ...
                for (i in 0 until itemsArray.length()) {
                    ...
                    val adapter = BookRVAdapter(booksList, this@LibraryFragment)
            ...
            Toast.makeText(this@LibraryFragment, "No books found..", Toast.LENGTH_SHORT)
                .show()
        })
